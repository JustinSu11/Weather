...
const CityNavigator = (props) => {
    return (
        <Tabs sx={{ borderRadius: '4px', minWidth: '80vw', maxWidth: '80vw' }} value={props.selectedCity ? `${props.selectedCity.cityName.name}, ${props.selectedCity.cityName.state}` : false} onChange={(event, newValue) => {
